# https://github.com/pavanhebbar/GalacticBulge/blob/main/python_codes/
...
def main(download_loc):  # table_loc, , rows_to_skip=4
    """Default run function."""
    # det_table = load_table(table_loc, skiprows=rows_to_skip)
    detid_list = ['101237009010018']  #det_table[:, 0].astype(int).astype(str).tolist()
    srcid_list = ['201237001010017']  #det_table[:, 1].astype(int).astype(str).tolist()
    srcnum_list = ['9']  #det_table[:, 2].astype(int).astype(str).tolist()
    obsid_list = ['123700901']  #det_table[:, 3].astype(int).astype(str).tolist()
